...
Day.create!(day_name:"Lunes", begin_turn: '8:00', end_turn: '16:00', branch_office:s1)
Day.create!(day_name:"Lunes", begin_turn: '10:00', end_turn: '18:00', branch_office:s2)
Day.create!(day_name:"Lunes", begin_turn: '7:00', end_turn: '15:00', branch_office:s3)

Day.create!(day_name:"Martes", begin_turn: '12:00', end_turn: '18:00', branch_office:s1)
Day.create!(day_name:"Martes", begin_turn: '10:00', end_turn: '20:00', branch_office:s2)
Day.create!(day_name:"Martes", begin_turn: '12:00', end_turn: '14:00', branch_office:s3)

Day.create!(day_name:"Miercoles", begin_turn: '8:00', end_turn: '16:00', branch_office:s1)
Day.create!(day_name:"Miercoles", begin_turn: '8:00', end_turn: '16:00', branch_office:s2)
Day.create!(day_name:"Miercoles", begin_turn: '8:00', end_turn: '16:00', branch_office:s3)

Day.create!(day_name:"Jueves", begin_turn: '9:00', end_turn: '14:00', branch_office:s1)
Day.create!(day_name:"Jueves", begin_turn: '9:00', end_turn: '14:00', branch_office:s2)
Day.create!(day_name:"Jueves", begin_turn: '9:00', end_turn: '14:00', branch_office:s3)

Day.create!(day_name:"Viernes", begin_turn: '11:00', end_turn: '14:00', branch_office:s1)
Day.create!(day_name:"Viernes", begin_turn: '11:00', end_turn: '14:00', branch_office:s2)
Day.create!(day_name:"Viernes", begin_turn: '11:00', end_turn: '14:00', branch_office:s3)
